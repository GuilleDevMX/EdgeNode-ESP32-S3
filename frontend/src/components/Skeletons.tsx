...
export const SkeletonChart = () => (
  <div className="bg-panel p-5 rounded-lg shadow-sm border border-border-color flex flex-col animate-pulse h-[300px]">
    ...
    <div className="flex-1 w-full flex items-end gap-2 px-2">
      {[...Array(12)].map((_, i) => (
        <div key={i} className="bg-gray-200 dark:bg-gray-700 w-full rounded-t-sm" style={{ height: `${Math.random() * 60 + 20}%` }}></div>
      ))}
    </div>
  </div>
);
    ...
    <table className="w-full text-left border-collapse">
      <thead>
        <tr className="bg-panel border-b border-border-color">
          <th className="px-6 py-3"><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-2/3"></div></th>
          <th className="px-6 py-3"><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div></th>
          <th className="px-6 py-3"><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div></th>
          <th className="px-6 py-3"><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/3 ml-auto"></div></th>
        </tr>
      </thead>
      <tbody className="divide-y divide-border-color">
        {[...Array(rows)].map((_, i) => (
          <tr key={i}>
            ...
            <td className="px-6 py-4"><div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div></td>
            <td className="px-6 py-4 flex justify-end"><div className="h-6 w-6 bg-gray-200 dark:bg-gray-700 rounded"></div></td>
          </tr>
        ))}
      </tbody>
    </table>
...
export const BlockLoader = () => (
  <div className="w-full flex items-center justify-center p-8 bg-black/5 dark:bg-white/5 rounded-lg border border-gray-800/10">
