...
import type { SensorConfig } from "../../interfaces/sensor";
      ...
      <form className="space-y-8" onSubmit={handleSaveSensors}>
        ...
        <section className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            {/* Calibración y ADC */}
            <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4 mt-2 p-4 bg-panel border border-border-color rounded">
              <div>
                <label className="label-field">
                  Pin ADC Batería
                </label>
